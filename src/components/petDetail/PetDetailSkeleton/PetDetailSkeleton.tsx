    ...
    <div className="pet-detail-skeleton-root anim-fade-in">
      ...
      <div className="pet-detail-skeleton-split">
        <div className="pet-detail-skeleton-media">
          <Skeleton variant="rounded" height="100%" className="pet-detail-skeleton-hero anim-skeleton-block" />
        </div>
        <Stack spacing={2} className="pet-detail-skeleton-aside">
          ...
          <div className="pet-detail-skeleton-stats">
            {map(Array.from({ length: 4 }), (_, i) => (
              <Skeleton key={i} variant="rounded" height={72} className="pet-detail-skeleton-stat anim-skeleton-block" />
            ))}
          </div>
      ...
      <div className="pet-detail-skeleton-strip">
        {map(Array.from({ length: STRIP_COUNT }), (_, i) => (
          <Skeleton key={i} variant="rounded" width={120} height={120} className="pet-detail-skeleton-thumb" />
        ))}
      </div>
    </div>
  )
